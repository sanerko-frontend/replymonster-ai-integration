<div>
    <div class="wrap replymonster-settings">
        <img class="replymonster-settings__logo" src="<?php echo esc_url(plugin_dir_url(__FILE__) . 'images/logo.png'); ?>" alt="ReplyMonster Logo">        <h1>Add personal access token to embed chatbot <br> to your website</h1>
